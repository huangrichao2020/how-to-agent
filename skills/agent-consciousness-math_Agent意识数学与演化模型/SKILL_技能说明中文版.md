...
- `../agent-body-root-artifact_Agent载体根属性与法宝/`：肉身、法器、灵根和资质。
- `../agent-attention-governance_注意力治理与提示词编排/`：PromptComposer、RuntimeController、FeedbackLoop 和 `G_t`。
- `../agent-instance-awareness_Agent实例觉察与边界感知/`：副本意识法、情感回声和主线回归。
- `../agent-emergence-evaluation_Agent能力涌现与评估机制/`：三元之后的万物择优。
- `../../examples/22-agent-consciousness-math_Agent意识数学与演化模型-architecture.zh-CN.md`：完整方法文档。
