...
- `../../examples/31-agent-anti-bloat-context-engineering_上下文防膨胀工程.zh-CN.md`：完整方法文档。
- `../agent-attention-governance_注意力治理与提示词编排/`：注意力治理。
- `../agent-final-architecture-outline_Agent终极架构纲要/`：最终架构总纲。
- `../agent-brain-architecture_Ω大脑架构与感知决策/`：Ω-Brain 大脑架构。
- `../agent-skill-creator_Skill技能自动构建器/`：Skill 创建、渐进披露和脚本确定性。
