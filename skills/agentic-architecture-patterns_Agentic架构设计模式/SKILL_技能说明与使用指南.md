---
name: agentic-architecture-patterns_Agentic架构设计模式
version: 2026-04-30
...
├── skills/                # SKILL_技能说明与使用指南.md bundles with _manifest.jsonl
...
- **Skill triggers**: Load full SKILL_技能说明与使用指南.md only when triggers match the current task.
...
DISCOVERY directives (question-form locking)
  ...
  + Active SKILL_技能说明与使用指南.md (matched by triggers)
  + Project metadata
