...
- **Read** `/mnt/skills/public/pptx/SKILL_技能说明与使用指南.md` before generating the PowerPoint (and its sub-reference `pptxgenjs.md` for creating from scratch)
...
Read `/mnt/skills/public/pptx/SKILL_技能说明与使用指南.md` and `/mnt/skills/public/pptx/pptxgenjs.md` before creating the slide.
