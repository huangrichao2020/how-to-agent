...
```jsx
// 步骤 1: Read 本 skill 的 assets/ios_frame.jsx（相对本 SKILL_技能说明与使用指南.md 的路径）
...
| SKILL_技能说明与使用指南.md体积超限 | 新写HTML>1000行 | 按`references/react-setup.md`的拆分策略拆成多jsx文件，末尾`Object.assign(window,...)`共享 |
