---
name: agent-emergence-evaluation_Agent能力涌现与评估机制
...
- `../../examples/29-agent-emergence-evaluation_Agent能力涌现与评估机制.md`: full method document.
- `../agent-attention-governance_注意力治理与提示词编排/`: attention governance layer.
- `../agent-final-architecture-outline_Agent终极架构纲要/`: final architecture outline.
- `../agent-consciousness-math_Agent意识数学与演化模型/`: consciousness math, log-to-data, and replay/eval.
