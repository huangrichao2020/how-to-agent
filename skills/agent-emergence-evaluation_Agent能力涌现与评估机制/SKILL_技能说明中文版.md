...
- `../../examples/29-agent-emergence-evaluation_Agent能力涌现与评估机制.zh-CN.md`：完整方法文档。
- `../agent-attention-governance_注意力治理与提示词编排/`：注意力治理层。
- `../agent-final-architecture-outline_Agent终极架构纲要/`：最终架构总纲。
- `../agent-consciousness-math_Agent意识数学与演化模型/`：意识数学、日志转数据和 replay/eval。
