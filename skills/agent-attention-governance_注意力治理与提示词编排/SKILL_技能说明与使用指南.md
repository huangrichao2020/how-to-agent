...
- `../../examples/28-agent-attention-governance_注意力治理与提示词编排.md`: full method document.
...
- `../agent-thinking-core_Agent思考核心与思维链/`: thinking core.
- `../agent-humanistic-light_Agent人文深度与关怀/`: humanistic light.
