---
name: agent-attention-governance_注意力治理与提示词编排
...
- `../../examples/28-agent-attention-governance_注意力治理与提示词编排.zh-CN.md`：完整方法文档。
- `../agent-final-architecture-outline_Agent终极架构纲要/`：最终架构总纲。
- `../agent-anti-bloat-context-engineering_上下文防膨胀工程/`：反堆砌与上下文工程。
- `../agent-brain-architecture_Ω大脑架构与感知决策/`：Ω-Brain 大脑架构。
- `../agent-thinking-core_Agent思考核心与思维链/`：思维内核。
- `../agent-humanistic-light_Agent人文深度与关怀/`：人文之光。
