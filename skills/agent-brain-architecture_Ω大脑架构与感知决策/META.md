...
- `../agent-thinking-core_Agent思考核心与思维链/` into the skill registry for essence, strategy,
  tactics, learning, analysis, and action thinking.
- `../agent-attention-governance_注意力治理与提示词编排/` into the skill registry for PromptComposer,
...
- Add `SKILL_技能说明与使用指南.md` to skill registry.
