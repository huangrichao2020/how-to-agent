...
- `../../examples/31-agent-anti-bloat-context-engineering.md`: full method document.
- `../agent-attention-governance/`: attention governance.
- `../agent-final-architecture-outline/`: final architecture outline.
- `../agent-brain-architecture/`: Ω-Brain architecture.
- `../agent-skill-creator/`: skill creation, progressive disclosure, and script determinism.
