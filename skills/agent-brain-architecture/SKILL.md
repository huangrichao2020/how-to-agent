...
- `../agent-attention-governance/`: PromptComposer, RuntimeController,
  FeedbackLoop, and `G_t`.
- `../agent-thinking-core/`: essence, strategy, tactics, learning, analysis, and action thinking.
- `../agent-consciousness-math/`: consciousness stages, utility, loss, and parameter correction.
