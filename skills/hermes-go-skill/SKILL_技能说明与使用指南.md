...
| **2. 设计 (DES)** | "架构", "方案", "结构", "数据库" | `agent-architecture_Agent架构设计与记忆系统-upstream-integration`, `software-development` |
| **3. 任务 (TASK)** | "计划", "拆分", "步骤", "todo" | `writing-plans`, `subagent-driven-development` |
| **4. 编码 (CODE)** | "改", "修", "bug", "代码", "写代码" | `autonomous-ai-agents_AI代理协作框架`, `systematic-debugging`, `test-driven-development` |
...
用户："帮我写个 API 接口"
-> **识别**：阶段 4 (CODE)
-> **加载**：`autonomous-ai-agents_AI代理协作框架`, `api-design`
-> **动作**：执行编码规范
