...
- `../../examples/23-agent-body-root-artifact.md`: full method document.
- `../agent-consciousness-math/`: consciousness math and parameter updates.
- `../agent-cultivation/`: cultivation realms and experience system.
